...
```
   mutation ($id: String!, $userId: String!) {
      subscribeToUser (data: { id: $id, userId: $userId }) {
         id
         firstName
         lastName
         email
...
```
   mutation ($id: String!, $userId: String!) {
      unsubscribeFromUser (data: { id: $id, userId: $userId }) {
         id
         firstName
         lastName
         email
...
https://github.com/Pandobeer/rsschool-nodejs-task-graphql/blob/45d75490182c0882b966eb9d363383e7eac648ed/src/routes/graphql/index.ts#L162-L166
